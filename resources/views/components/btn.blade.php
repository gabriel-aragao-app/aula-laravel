...
<br>
<button class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-emerald-600 hover:bg-emerald-700 font-semibold rounded-lg transition duration-200 shadow-sm btn-confirmar" background-color="{{ $cor }}">
        {{ $nomeBotao }}    
